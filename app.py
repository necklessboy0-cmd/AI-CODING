...
#
# API integrations and generation logic are added in Parts 2–4.
# ============================================================
...
st.markdown(
    """
    <div class="footer">
        AI Code Builder • Prompt → Review → Generate → Test → Fix
    </div>
    """,
    unsafe_allow_html=True,
)
...
"""
        ...
        reviewed_prompt = response.text.strip()
